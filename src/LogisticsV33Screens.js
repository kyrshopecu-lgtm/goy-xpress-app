...
export function CourierWaitController({request,secret,onUpdated}){
  ...
  const notifyAdmin=()=>{const text=`GOY XPRESS - Novedad de espera\nSolicitud: ${request.code}\nSe cumplieron 10 minutos de espera. El mensajero requiere instrucción.`;Linking.openURL(`https://wa.me/${ADMIN_WHATSAPP}?text=${encodeURIComponent(text)}`);};
