    ...
    <section class="goy-client-card" role="dialog" aria-modal="true" aria-labelledby="createClientTitle">
      ...
      <form id="createClientForm">
        <div class="goy-client-grid">
          ...
          <label class="wide">Dirección escrita<input id="newClientAddress" autocomplete="street-address" placeholder="Ej. Mariana de Jesús y Jorge Juan, Quito" /></label>
          <label class="wide">Ubicación de Google Maps (opcional)<input id="newClientMapUrl" type="url" inputmode="url" autocomplete="off" placeholder="Pega aquí el enlace compartido de Google Maps" /><span class="goy-map-help">En Google Maps toca Compartir → Copiar enlace y pégalo aquí. La dirección escrita y la ubicación pueden guardarse juntas.</span></label>
