...
2. En **Settings → Secrets and variables → Actions** agrega
   `EXPO_PUBLIC_SUPABASE_PUBLISHABLE_KEY`. La URL pública correcta del proyecto
   se valida automáticamente durante la compilación.
...
7. Descarga **GOY-XPRESS-v3.2.2-INSTALABLE** en **Artifacts**.
8. Descomprime el archivo para obtener `GOY-XPRESS-v3.2.2-INSTALABLE.apk`.

El APK se puede instalar como actualización porque conserva el paquete
`com.goyxpress.mensajeria` e incrementa `versionCode` a 8. Antes de distribuir,
